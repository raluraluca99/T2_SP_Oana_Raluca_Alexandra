...
f=1/P;
t=-2*P:0.4:2*P;
D=15;   %durata semnalului dreptunghiular in functie de numarul de ordine
duty = 37.5;      %factorul de umplere duty=D/40*100
...
stem(0:N,Ak),title('Spectrul lui x(t)');                     %se afiseaza spectrul de valori
figure(1);
plot(t,x_modificat,'.',t,x_dr),title('x(t)(linie solida) si reconstructia folosind N coeficienti (linie puncata)');
